...
const SavedCoin = () => {
 ...
 const deleteCoin = async (passedid) => {
  ...
  return (
    <div>
        {coins?.length === 0 ? (<p>You don't have any coins saved. Please save a coin to add it to watch list. <Link to='/' className='  text-blue-500'>Click here to view coins</Link></p>) : (
